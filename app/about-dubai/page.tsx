...
export default function AboutDubaiPage() {
  return (
    <div>
      {/* Hero Section - videos one by one with loading until first plays */}
      <AboutDubaiHero />
        ...
        <div className="container-wide">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {neighborhoods.map((neighborhood) => (
              <Card key={neighborhood.name} className="bg-primary-foreground/5 border-primary-foreground/10 dark:bg-background/50 dark:border-border">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-primary-foreground/90 dark:text-foreground/90">Key Highlights:</p>
