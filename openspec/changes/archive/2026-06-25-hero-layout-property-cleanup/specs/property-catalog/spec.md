...
### Requirement: Retired property inventory

**Reason**: These six listings are no longer offered and should not appear in the public catalog.

**Migration**: Delete the property entries for Golf Vale, Fior 1, Edition Residences, Bella by Passo, Casa Burés, and AM Residences from `lib/data/properties.ts`. Verify no hardcoded slug references remain in components.
